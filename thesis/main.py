...
if __name__=="__main__":
    ...
    ppo = 0
    #mod = 'GCN2'
    #placement = Placement(feature_dim, hidden_dim, lookahead_block_num, grid_size, learning_rate, lmbda, gamma, alpha,beta, epsilon, mod)
    ...
    for step in range(train_step):
        data, reward_list, done_list, prob_list, action_list,ave_reward = Simulation.Run_simulation(simulation_day=5, scheduling_mode=scheduling_mode, init_yard=eval_set[0][0].copy(), init_block=eval_set[0][1].copy(), batch_step=20)
